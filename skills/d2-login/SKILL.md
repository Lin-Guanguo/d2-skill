...
- `d2-items`: owned item facts, roll and wishlist evidence, duplicate cleanup review, transfers, safe atomic gear actions, socket inspection/free reusable plug insertion, and in-game loadout inspection/management.
